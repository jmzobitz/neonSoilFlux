...
An overview of the package is also presented in [`neonSoilFlux`: An R Package for Continuous Sensor-Based Estimation of Soil CO~2~ Fluxes](https://doi.org/10.1111/2041-210x.70216).
